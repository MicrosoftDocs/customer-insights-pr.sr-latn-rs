...
1. Da biste dodali dodatne entitete u izvor podataka dijalogu "**Uređivanje upita", idite** na opciju "Kuća" i **izaberite** stavku "Uzmi **podatke"**.
